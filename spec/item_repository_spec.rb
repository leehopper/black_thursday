...
RSpec.describe ItemRepository do
  ...
  it 'creates new id number' do
    expect(@repo.new_item_id_number).to eq(263445612)
  end
  ...
  it 'creates new item instance' do
    ...
    expect(@repo.find_by_id(263445612).name).to eq('jersey')
    expect(@repo.find_by_id(263445612).description).to eq('clothing')
    expect(@repo.find_by_id(263445612).unit_price).to eq(0.2e0)
  end
